/*
	Extension for the '/zeus/ideas/ideas_database_crud_hooks' Extension Point!
...
exports.beforeCreate = function(connection, entity) {
	console.log('Before creating new entity \'' + entity + '\' in table \'CMC_IDEAS\'');
};

exports.afterCreate = function(connection, entity) {
	console.log('After creating new entity \'' + entity + '\' in table \'CMC_IDEAS\'');
};

exports.beforeUpdate = function(connection, entity) {
	console.log('Before updating table \'CMC_IDEAS\' with entity \'' + entity + '\'');
};

exports.afterUpdate = function(connection, entity) {
	console.log('After updating table \'CMC_IDEAS\' with entity \'' + entity + '\'');
};

exports.beforeDelete = function(connection, entity) {
	console.log('Before deleting entity \'' + entity + '\' from table \'CMC_IDEAS\'');
};

exports.afterDelete = function(connection, entity) {
	console.log('After deleting entity \'' + entity + '\' from table \'CMC_IDEAS\'');
};
