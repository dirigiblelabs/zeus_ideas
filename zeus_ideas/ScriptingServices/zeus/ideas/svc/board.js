...
var boardDAO = require("zeus/ideas/lib/board_dao");

var Board = arester.asRestAPI(boardDAO);
Board.prototype.logger.ctx = "ZEUS Board Svc";

Board.prototype.boardVotes = require("zeus/ideas/lib/board_votes");
Board.prototype.boardTags = require("zeus/ideas/lib/board_tags");
