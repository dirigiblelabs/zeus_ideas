...
var BoardsORM = {
	dbName: "ZEUS_IDEAS_BOARD",
	properties: [
		{
			name: "id",
			dbName: "ZEUS_IDEASB_ID",
			id: true,
			required: true,
			type: "Long"
		},{
			name: "shortText",
			dbName: "ZEUS_IDEASB_SHORT_TEXT",
			type: "String",
			size: 500
		},{
			name: "description",
			dbName: "ZEUS_IDEASB_DESCRIPTION",
			type: "String",
			size: 10000
		},{
			name: "publishTime",
			dbName: "ZEUS_IDEASB_PUBLISH_TIME",
			required: true,
			type: "Long",
			...
			dbName: "ZEUS_IDEASB_LASTMODIFIED_TIME",
			type: "Long",
