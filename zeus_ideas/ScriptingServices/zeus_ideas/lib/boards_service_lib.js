...
var BoardsDataService = function(){
	...
	var self = this;	
	this.boardVotes = require("zeus_ideas/lib/board_votes_dao").get();
	this.boardTags = require("zeus_ideas/lib/board_tags_dao").get();
	...
	var boardStatsDataService = require("zeus_ideas/lib/board_stats_service_lib").get();
